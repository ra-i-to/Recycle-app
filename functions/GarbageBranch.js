export default function createReturnMessage(message) {
  ...
  switch (true) {
    ...
    case /アンテナ/.test(message):
      returnMessage =
        "アンテナの分別方法\n\n【テレビ用・室内用の小さいもの】\n分別:小型家電\n協力店舗・市有施設ai等に持ち込んでください。(持ち込み施設MAP参照)\n\n【テレビ用・屋外用・BS・CSを含む】\n分別:粗大ごみ\n出し方:\n持ち込み:無料\n  戸別収集手数料:500円\n";
      break;
    ...
    case /タオル/.test(message):
      returnMessage = "タオルの分別方法\n\n分別:資源化物\n古布";
      break;

    case /タオルケット/.test(message):
      returnMessage = "タオルケットの分別方法\n\n分別:粗大ごみ\n寝具";
      break;

    case /ダウンジャケット/.test(message):
      returnMessage = "ダウンジャケットの分別方法\n\n分別:資源化物\n古布";
      break;
    ...
    case /竹馬/.test(message):
      returnMessage = "竹馬の分別方法\n\n分別:粗大ごみ\n戸別収集手数料:200円";
      break;

    case /竹ぼうき/.test(message):
      returnMessage = "竹ぼうきの分別方法\n\n分別:粗大ごみ\n60cm以下なら可燃";
      break;
    ...
    case /畳/.test(message):
      returnMessage = "畳の分別方法\n\n分別:粗大ごみ\n戸別収集手数料:500円";
      break;

    case /脱臭剤/.test(message):
      returnMessage = "脱臭剤の分別方法\n\n分別:可燃ごみ";
      break;
    ...
    case /単行本/.test(message):
      returnMessage = "単行本の分別方法\n\n分別:資源化物";
      break;

    case /ダンベル/.test(message):
      returnMessage = "ダンベルの分別方法\n\n分別:不燃ごみ";
      break;

    case /ダンボール/.test(message):
      returnMessage = "ダンボールの分別方法\n\n分別:資源化物\n古紙";
      break;
    ...
    case /地球儀/.test(message):
      returnMessage = "/地球儀の分別方法\n\n分別:可燃ごみ\n18ℓ缶以上は粗大";
      break;

    case /竹炭/.test(message):
      returnMessage = "竹炭の分別方法\n\n分別:可燃ごみ";
      break;
    ...
    case /茶筒缶/.test(message):
      returnMessage = "茶筒缶の分別方法\n\n分別:資源化物";
      break;

    case /茶箱/.test(message):
      returnMessage = "茶箱の分別方法\n\n分別:可燃ごみ\n18ℓ缶以上は粗大";
      break;

    case /茶碗/.test(message):
      returnMessage = "茶碗の分別方法\n\n分別:不燃ごみ";
      break;
    ...
    case /土/.test(message):
      returnMessage = "土の分別方法\n\n分別:出せないごみ";
      break;

    case /爪切り/.test(message):
      returnMessage = "爪切りの分別方法\n\n分別:不燃ごみ";
      break;

    case /釣り糸/.test(message):
      returnMessage = "釣り糸の分別方法\n\n分別:可燃ごみ";
      break;
    ...
    case /テレビ台/.test(message):
      returnMessage = "テレビ台の分別方法\n\n分別:粗大ごみ";
      break;

    case /テレフォンカード/.test(message):
      returnMessage = "テレフォンカードの分別方法\n\n分別:可燃ごみ";
      break;
    ...
    case /電気アンカ/.test(message):
      returnMessage = "電気アンカーの分別方法\n\n分別:小型家電";
      break;

    case /電気カーペット/.test(message):
      returnMessage = "電気カーペットの分別方法\n\n分別:粗大ごみ";
      break;

    case /電気カミソリ/.test(message):
      returnMessage = "電気カミソリの分別方法\n\n分別:小型家電";
      break;
    ...
    case /電話機/.test(message):
      returnMessage = "電話機の分別方法\n\n分別:小型家電";
      break;

    case /電話帳/.test(message):
      returnMessage = "電話帳の分別方法\n\n分別:資源化物\n古紙";
      break;
    ...
    case /トイレットペーパー/.test(message):
      returnMessage = "トイレットペーパーの分別方法\n\n分別:可燃ごみ";
      break;

    case /トイレットペーパーの芯/.test(message):
      returnMessage = "トイレットペーパーの芯の分別方法\n\n分別:資源化物\n古紙";
      break;
    ...
    case /陶磁器類/.test(message):
      returnMessage = "陶磁器類の分別方法\n\n分別:不燃ごみ";
      break;

    case /灯油/.test(message):
      returnMessage = "灯油の分別方法\n\n分別:出せないごみ\n販売店に相談";
      break;
    ...
    case /土鍋/.test(message):
      returnMessage = "土鍋の分別方法\n\n分別:不燃ごみ";
      break;

    case /ドライバー/.test(message):
      returnMessage = "ドライバーの分別方法\n\n分別:不燃ごみ";
      break;

    case /ドライヤー/.test(message):
      returnMessage = "ドライヤーの分別方法\n\n分別:小型家電";
      break;

    case /ドラム缶/.test(message):
      returnMessage = "ドラム缶の分別方法\n\n分別:出せないごみ";
      break;
    ...
    case /灰皿/.test(message):
      returnMessage =
        "灰の分別方法\n\n【灰（少量）】\n分別:不燃ごみ:水に湿らせて新聞紙に包んでから袋に入れ、少量ずつ出す（「灰」と書く）\n\n【灰皿 卓上用】\n分別:不燃ごみ\n\n【灰皿 据置型】\n分別:粗大ごみ";
      break;
    ...
    case /パソコン/.test(message):
    case /デスクトップパソコン/.test(message):
    case /ノートパソコン/.test(message):
    case /マウス/.test(message):
    case /パソコンのモニター/.test(message):
    ...
    case /発泡トレイ/.test(message):
      returnMessage =
        "発泡トレイの分別方法\n\n分別:拠点:拠点回収所に出す。地域の資源化物収集ステーションには出せません。資源化物の拠点回収（民間協力事業者・登録電器店）資源化物の拠点回収（市有施設）";
      break;
    ...
    case /虫メガネ/.test(message):
      returnMessage =
        "虫メガネの分別方法\n\n分別:不燃ごみ:プラスチック製の場合は可燃ごみで出してください。";
      break;
