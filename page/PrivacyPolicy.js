...
function PrivacyPolicy() {
  ...
  return (
    ...
    <Text style={styles.normalText}>専門学校岡山情報ビジネス学院（以下，「当校」といいます。）は，本アプリ上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
</Text>
    ...
    <Text style={styles.normalText}>当校が個人情報を収集・利用する目的は，以下のとおりです。{"\n"}<View style={styles.innerText}>1.当校サービスの提供・運営のため</View>{"\n"}<View style={styles.innerText}>2.ユーザーからのお問い合わせに回答するため（本人確認を行うことを含む）</View>{"\n"}<View style={styles.innerText}>3.メンテナンス，重要なお知らせなど必要に応じたご連絡のため</View>{"\n"}<View style={styles.innerText}>4.利用規約に違反したユーザーや，不正・不当な目的でサービスを利用しようとするユーザーの特定をし，ご利用をお断りするため</View>{"\n"}<View style={styles.innerText}>5.ユーザーにご自身の登録情報の閲覧や変更，削除，ご利用状況の閲覧を行っていただくため</View>{"\n"}<View style={styles.innerText}>6.上記の利用目的に付随する目的</View></Text>
    <View style={styles.spaceLine}></View>
    ...
    <Text style={styles.normalText}>1.当校は，次に掲げる場合を除いて，あらかじめユーザーの同意を得ることなく，第三者に個人情報を提供することはありません。ただし，個人情報保護法その他の法令で認められる場合を除きます。{"\n"}<View style={styles.innerText}>1.人の生命，身体または財産の保護のために必要がある場合であって，本人の同意を得ることが困難であるとき</View>{"\n"}<View style={styles.innerText}>2.公衆衛生の向上または児童の健全な育成の推進のために特に必要がある場合であって，本人の同意を得ることが困難であるとき</View>{"\n"}<View style={styles.innerText}>3.国の機関もしくは地方公共団体またはその委託を受けた者が法令の定める事務を遂行することに対して協力する必要がある場合であって，本人の同意を得ることにより当該事務の遂行に支障を及ぼすおそれがあるとき</View>{"\n"}<View style={styles.innerText}>4.予め次の事項を告知あるいは公表し，かつ当校が個人情報保護委員会に届出をしたとき</View>{"\n"}<View style={styles.innerText}><View style={styles.innerText}>1.利用目的に第三者への提供を含むこと</View></View>{"\n"}<View style={styles.innerText}><View style={styles.innerText}>2.第三者に提供されるデータの項目</View></View>{"\n"}<View style={styles.innerText}><View style={styles.innerText}>3.第三者への提供の手段または方法</View></View>{"\n"}<View style={styles.innerText}><View style={styles.innerText}>4.本人の求めに応じて個人情報の第三者への提供を停止すること</View></View>{"\n"}<View style={styles.innerText}><View style={styles.innerText}>5.本人の求めを受け付ける方法</View></View>{"\n"}2.前項の定めにかかわらず，次に掲げる場合には，当該情報の提供先は第三者に該当しないものとします。{"\n"}<View style={styles.innerText}>1.当校が利用目的の達成に必要な範囲内において個人情報の取扱いの全部または一部を委託する場合</View>{"\n"}<View style={styles.innerText}>2.合併その他の事由による事業の承継に伴って個人情報が提供される場合</View>{"\n"}<View style={styles.innerText}>3.個人情報を特定の者との間で共同して利用する場合であって，その旨並びに共同して利用される個人情報の項目，共同して利用する者の範囲，利用する者の利用目的および当該個人情報の管理について責任を有する者の氏名または名称について，あらかじめ本人に通知し，または本人が容易に知り得る状態に置いた場合</View></Text>
    <View style={styles.spaceLine}></View>
    <Text style={styles.headerText}>第6条（個人情報の開示）</Text>
    <Text style={styles.normalText}>1.当校は，本人から個人情報の開示を求められたときは，本人に対し，遅滞なくこれを開示します。ただし，開示することにより次のいずれかに該当する場合は，その全部または一部を開示しないこともあり，開示しない決定をした場合には，その旨を遅滞なく通知します。{"\n"}<View style={styles.innerText}>1.本人または第三者の生命，身体，財産その他の権利利益を害するおそれがある場合</View>{"\n"}<View style={styles.innerText}>2.当校の業務の適正な実施に著しい支障を及ぼすおそれがある場合</View>{"\n"}<View style={styles.innerText}>3.その他法令に違反することとなる場合</View>{"\n"}2.前項の定めにかかわらず，履歴情報および特性情報などの個人情報以外の情報については，原則として開示いたしません。</Text>
    <View style={styles.spaceLine}></View>
